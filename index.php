	...
	//var_dump(test("Nguyễn Hoàng Phi","tn_183"));
	//var_dump(is_array(FindStudentsByName("Nguyễn Hoàng Phi","tn_183")));
	//var_dump(in_array('13160005TP',FindStudentsByName("Nguyễn Hoàng Phi","tn_183")));
	//var_dump(FindStudentsByName("Nguyễn Hoàng Phi","tn_183"));
	//var_dump(in_array('13160005TP',test("Nguyễn Hoàng Phi","tn_183")));
	//var_dump(array_unique(FindAllStudentsByName("Nguyễn Hoàng Phi",['tn_183','tn_191','tn_192','tn_193']),0));
	if (isset($_POST['find']))
	{
	...
	<div class="container-fluid">		
		...
		<div class = "row">
			<div class ="col">
				<div id="home" class = "float-right">
					<a href="index.php"><img class='img-fluid' id = "img-home" src = "images/logo/home-white-5.png" alt ="Trở lại trang chủ" /></a>
				</div>
			</div>
		</div>
		...
		<div id = "find-table" class ="row justify-content-center" style = "<?php echo $flag_find_table; ?>" >
			<div class = "col-sm-6 find_mssv">
				...
				<!-- Progress bar -->
				<div style = 'font-size:18px; background-color:#007bff' class = "full-screen font-weight-bold text-dark text-center"><span class="align-middle">ỨNG DỤNG TRA CỨU THÔNG TIN TÌNH TRẠNG XÉT TỐT NGHIỆP</span></div>
